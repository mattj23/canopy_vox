...
mpi_test: $(SRC)mpi_test.cpp $(BIN)jsoncpp.o $(BIN)utilities.o $(BIN)vector3d.o $(BIN)pointcloud.o $(BIN)voxelsorter.o
	$(MPICC) $(SRC)mpi_test.cpp $(BIN)jsoncpp.o $(BIN)utilities.o $(BIN)vector3d.o $(BIN)pointcloud.o $(BIN)voxelsorter.o -o $(BIN)mpi_test $(CFLAGS)
